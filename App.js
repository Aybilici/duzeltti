        ...
        <Route>
          <header className="App-header">
            ...
            <div className="example2">
              <h3>Hoşgeldiniz!!</h3>
              <p>
                Form başlıkları aşağıdaki gibidir. Tanışma eğitimleri yılda 2
                defa açılır: Şubat/Mart-Mayıs dönemi veya Eylül/Ekim-Aralık
                dönemi.
              </p>
            </div>
          </header>
              ...
              <Card style={form}>
                <CardContent>
                  ...
                  <Typography variant="body2" component="p">
                    Dem Derneği&#39;nin Türk İşaret Dili ile Tanışma Eğitimi
                    katılımcılarından bir tanesi olmak için formu doldurmanı
                    rica ediyoruz.
                  </Typography>
                </CardContent>
            ...
            <div className="form2">
              <Card style={form}>
                <CardContent>
                  ...
                  <Typography variant="body2" component="p">
                    Dem Derneği&#39;nin Türk İşaret Dili ile Tanışma ve Proje
                    Geliştirme Eğitimi katılımcılarından bir tanesi olmak için
                    formu doldurmanı rica ediyoruz.
                  </Typography>
                </CardContent>
